...
import { ICON_ACTION, ICON_APPLY, ICON_DECLINE, ICON_HAMMER, ICON_HIT, ICON_MUSIC, ICON_PUNCH, ICON_ROGUE, ICON_SLEEP, ICON_STEAL, ICON_WARRIOR } from "../icons";
...
export const thievPathDialog = new Dialog(
  ...
  [
    ...
    new Phrase(
      ...
      [],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "pobeg"), new Effect(ACTION_MESSAGE, "=", "Тебе не улыбается вступать в какую-то банду из захолустья. Убедительно дирижируя кинжалом, ты убеждаешь бандитов отдать тебе долю добычи и, прихватив одного из оставленных ими неподалеку коней, скачешь вперед к горизонту и новым приключениям.") ])],
      "epilogue1"
    ),
  ]
)
...
export const thievInviteGangDialog = new Dialog(
  "inviteGang",
  [
    "Спустя несколько часов, вы прибываете в лагерь бандитов, скрытый в лесу. Помимо прочих бандитов, вас встречает рослый, покрытый шрамами и татуировками верзила. Похоже это главарь банды, о котором тебе уже успел рассказать один из подельников - капитан Шмяк, грозный пират. Правда без корабля. Потому что в лесу кораблям делать нечего.",
  ...
  [
    new Phrase(
      ...
      [],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "abus"), new Effect(ACTION_MESSAGE, "=", "Ты понимаешь, что вступить в бой с превосходящим врагом себе дороже. Нужно усыпить их бдительность, а потом действовать. Незаметно пряча отмычку в рукав, ты позволяешь разоружить себя и заковать в кандалы.") ])],
      "thievGiveUp"
    ),
    new Phrase(
      "Вступить в бой", "attack", ICON_WARRIOR,
      [],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "abus"), new Effect(ACTION_MESSAGE, "=", "Резко толкнув стоящего рядом бандита в сторону Шмяка, ты уходишь вбок ловким пируэтом, попутно разряжая арбалет в капитана.") ])],
      "thievOnAttack"
    ),
  ]
);
...
export const thievGiveUpDialog = new Dialog(
  ...
  [
    ...
    "Незаметно вытащив отмычку, ты быстро вскрываешь замок и смотришь в сторону капитанского шатра. Ты бы могла просто сбежать, у тебя всегда была такая возможность. Но не сейчас - Шмяку нужно преподать урок. Глядя на пьяных разбойников, ты обдумываешь план мести."
  ],
  [
    new Phrase(
      "Разобраться с Шмяком", "attack", ICON_PUNCH,
      [],
      [],
      "thievActionAbuse"
    ),
...
export const thievActionAbuseDialog = new Dialog(
  ...
  [
    ...
    "Вот он - Шмяк. Слегка покачиваясь от выпитого эля, он стоит к тебе спиной, изучая содержимое одного из бочонков. Он даже не поймет, что с ним случится:",
  ],
  [
    new Phrase(
      "Пронзить кинжалом", "attack", ICON_WARRIOR,
      [],
      [ new Action([ 
...
export const thievAfterActionAbuseDialog = new Dialog(
  "thievAfterActionAbuse",
  [
    "Выйдя из капитанского  шатра, ты громко объявляешь о том, что капитан Шмяк...",
  ],
  [
    new Phrase(
      "Мертв", "killed", ICON_PUNCH,
...
export const thievPoisonGangDialog = new Dialog(
  ...
  [
    ...
    new Phrase(
      "Сильнейшее снотворное", "sleep", ICON_SLEEP,
      [ new Condition("abuseStunned", "==", true)],
...
export const thievAfterPoisonGangDialog = new Dialog(
  ...
  [
    new Phrase(
      ...
      [ new Condition("abuseKilled", "==", true)],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "klirik_light"), new Effect(DIALOG_IMAGE, "=", "oleja"), new Effect(ACTION_MESSAGE, "=", "...погрузить все добро в лагере на стоящих здесь лошадей и вернуться в деревню. Где тебя, без сомнения, наградят за уничтожение ужасного  Шмяка и его банды.") ])],
      "epilogue2"
    ),
    new Phrase(
      "Связать разбойников", "sleep", ICON_STEAL,
      [ new Condition("abuseStunned", "==", true)],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "klirik_light"), new Effect(ACTION_MESSAGE, "=", "...связать разбойников покрепче и послать за ополченцами и сэром Олэйджей Стеной. А уже они, без сомнения, наградят тебя за победу над ужасным Шмяком и его бандой.") ])],
      "epilogue2"
    ),
  ]
);
...
export const thievOnAttackDialog = new Dialog(
  "thievOnAttack",
  [
    "Эх, немного промахнулась! Арбалетный болт попадает Шмяку в плечо и он яростно кричит:",
    "- Все назад! Я сам покажу этой женщине, где ее место!",
    "Да будет так. Зарядив арбалет новым болтом, во вторую ты берешь свой острый кинжал. Подняв над головой меч, капитан яростно орет и бросается на тебя. Начинается танец со смертью под аккомпанемент звона стали, воплей Шмяка и:"
  ],
  [
    new Phrase(
...
export const thievGoAttackDialog = new Dialog(
  "thievGoAttack",
  [
    "Здоровяк явно сильнее тебя, но на твоей стороне скорость и ловкость. При очередной атаке бандита ты делаешь через него виртуозное сальто и стреляешь прямо в ступню, пригвоздив его ногу к земле. Шмяк издает вопль боли и падает на одно колено - этой заминки более чем достаточно. Прокрутив в руке кинжал, ты:"
  ],
  [
    new Phrase(
      "Пронзаешь им врага", "attack", ICON_WARRIOR,
      [],
      [ new Action([ 
...
export const thievFinalDialog = new Dialog(
  ...
  [
    new Phrase(
      "Отпустить крестьянок", "back", "",
      [ new Condition("abuseKilled", "==", true)],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "slejka"), new Effect(ACTION_MESSAGE, "=", "...отпустить крестьянок, прежде получив за них выкуп от деревни. Радостные разбойники славят хитрость и смекалку своей новой атаманши.") ])],
      "epilogue3"
    ),
    new Phrase(
      "Сдать властям Шмяка", "sleep", "",
      [ new Condition("abuseStunned", "==", true)],
      [ new Action([ new Effect(DIALOG_IMAGE, "=", "slejka"), new Effect(ACTION_MESSAGE, "=", "...отпустить крестьянок, прежде получив за них выкуп от деревни, а также сдать Шмяка властям за вознаграждение. Радостные разбойники славят хитрость и смекалку своей новой атаманши.") ])],
      "epilogue3"
    ),
  ]
);
