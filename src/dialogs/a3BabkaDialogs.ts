...
export const babkaDialog = new Dialog(
    ...
    [
    new Phrase(
        "Бабка виновата!", "punch_babka", ICON_PUNCH,        
        [],
        [ 
            new Action([ 
              new Effect(ACTION_MESSAGE, "=", `Старая кулёма загнала кисю на дерево?! Получай!\n\nХорошенько размахнувшись, ты впечатываешь кулак в челюсть старухи, вырубая ее. Довольно крякнув, ты собираешься сказать котенку, что опасность миновала. Однако, повернувшись в его сторону, видишь лишь летящий на тебя яростный, но неимоверно очаровательный клубочек зубов и когтей. Малыш, ловко приземлившись тебе прямо на лицо, начинает царапаться и кусаться, после чего спрыгивает на землю, встав между тобой и бессознательной старушкой и грозно шипит.`),
    ...
    new Phrase(
        ...
        [
          new Action( [ new Effect(DIALOG_IMAGE, "=", "catmagic"), new Effect(DIALOG_IMAGE, "=", "Как тигр, как барс взмываешь ты ловким прыжком на ветку и, подхватив котенка, также сноровисто спрыгиваешь вниз к ожидающей его хозяйке. Бабуля благодарит за помощь и уходит вместе с котенком.") ])
        ],
        "success",
    ),
    new Phrase(
