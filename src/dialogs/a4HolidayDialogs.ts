...
export const nextDayDialog = new Dialog(
  "nextDay",
  [
    "На следующий день, ты просыпаешься от громких криков с улицы. Выйдя из таверны и протерев заспанные глаза, ты видишь что в центре деревенской площади на постаменте стоит тучный мужчина, судя по богатой одежде - деревенский староста Никтас Заводила, громко кричащий в жестяной рупор:",
...
export const gnomDialog = new Dialog(
  ...
  [
    ...
    "- Уважаемый Никтас, но ведь такая рань! Нам бы начать после полудня, а не сейча...",
